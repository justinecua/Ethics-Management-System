...
var calendar = new FullCalendar.Calendar(calendarEl, {
  ...
  eventClick: function (info) {
    ...
    document.getElementById("eschedule-type").value =
      event.extendedProps.schedule_type || "Available";
    document.getElementById("eschedule-date").value =
      event.extendedProps.schedule_date;
    ...
    document.getElementById("edit-schedule-form").action =
  ...
  eventContent: function (arg) {
    ...
    var endTime = arg.event.end
      ...
      : "";
    var scheduleTypeClass =
      arg.event.extendedProps.schedule_type === "Available"
        ? "Available"
        : "Not-Available";
