...
from .models import Student, Appointments, Accounts, Reviewer, Account_Type, College, Category, EthicalRiskQuestions, Manuscripts, Schedule, Notification, Comments
